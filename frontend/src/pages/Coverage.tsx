...
export default function Coverage() {
  ...
  const { data, refetch, isLoading } = useQuery({
    queryKey:['coverage', eff],
    queryFn: async()=> (await api.get('/api/v1/coverage', { params: { projectId: eff, organizationId: eff } })).data.data,
    enabled: !!eff
  })
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-end">
        <div><h1 className="text-2xl font-bold">Security Coverage</h1><p className="text-sm text-slate-500">SAST â€¢ SCA â€¢ Secrets â€¢ DAST â€¢ API â€¢ Mobile â€¢ Cloud â€¢ ThreatModel</p></div>
