...
@RestController @RequestMapping("/api/v1/ai-assets") @RequiredArgsConstructor
public class AiLlmController {
    private final AiLlmService svc;
    @PostMapping public ApiResponse<?> create(@RequestBody AiAsset e){ return ApiResponse.ok(svc.create(e)); }
