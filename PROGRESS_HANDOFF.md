...
8. **Sisa nyata: modul 0% lain (FindingLifecycle, ValidationGate, NextBestAction, Sso, JwtFilter/Provider, TenantFilter) sudah punya test files lama, tinggal run full suite `mvn test`**
